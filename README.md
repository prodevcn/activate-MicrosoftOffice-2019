...
2. Input following cmd lines.
```
cd /d %ProgramFiles%\Microsoft Office\Office16
cd /d %ProgramFiles(x86)%\Microsoft Office\Office16
```

Move to ms offcie directory.
...
# Other way using batch file

Create a batch file with .cmd extension.

Then, write following description.
...
Then, run that file in Administrator mode.
